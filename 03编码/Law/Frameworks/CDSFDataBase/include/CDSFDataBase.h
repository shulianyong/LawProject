...
//数据自动绑定
/*
 实体解析，可直接使用reflectDataFromDictionary方法进入
 */
...
//数据库操作如使用如下。
/*
[db executeDataBaseOPeration:^{    
    [db executeUpdate:@"create table namedparamtest (a text, b text, c integer, d double)"];
